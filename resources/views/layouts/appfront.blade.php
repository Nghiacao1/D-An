...
<body>
                ...
                <nav class="navbar-2 navbar-expand-md navbar-light bg-light shadow-sm">
                    <div class="container">
                        ...
                        <a href="{{ url('/carts/view') }}" class="navbar-brand" style="margin-top: 55px; margin-left:550px"><i class="fa fa-cart-plus"></i></a>
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            ...
                            <div style="margin-top: 55px" class="d-flex flex-row-reverse">
                                    ...
                                    @else                     
                                        <li class="nav-item dropdown">
                                            <a id="navbarDropdown" class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                                                {{$cus = auth()->guard('customer')->user()->fullname}}
                                            </a>
